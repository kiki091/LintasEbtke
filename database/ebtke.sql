...
INSERT INTO `contact_us` VALUES (3,'kiki kurniawan','sheqbo@gmail.com','','asfasf adgfas asgas','2017-08-19 06:10:24');
...
INSERT INTO `event` VALUES (1,'thumbnail_002.jpg',1,1,'2017-05-16 08:05:30','2017-05-16 23:05:34',NULL,'2017-05-16 08:05:30','2017-05-16 08:05:30',1),(2,'event__lintas__ebtke596047b62cf6a_577x305.jpg',1,2,'2017-08-07 08:30:00','2017-08-07 17:30:00',1,'2017-07-08 02:47:18','2017-07-08 05:33:09',1),(3,'event__lintas__ebtke59a245e1d5a13_577x305.jpg',1,3,'2017-08-27 10:00:53','2017-08-27 10:30:57',0,'2017-08-27 04:09:05',NULL,1);
...
INSERT INTO `event_images` VALUES (1,'event__lintas__ebtke596047b62cf6a_930x493.jpg','2017-07-08 02:47:18','2017-07-08 02:47:18',2),(3,'event__lintas__ebtke596072291cfbc_930x493_2.jpg','2017-07-08 05:48:25','2017-07-08 05:48:25',2),(4,'event__lintas__ebtke59a245e1d5a13_930x493.jpg','2017-08-27 04:09:05','2017-08-27 04:09:05',3),(5,'event__lintas__ebtke59a245e1d5a13_930x493_2.jpg','2017-08-27 04:09:05','2017-08-27 04:09:05',3);
...
INSERT INTO `news` VALUES (1,'thumbnail_002.jpg',1,1,13,'2017-06-07 07:39:45','2017-06-07 07:39:45',NULL,1),(3,'thumbnail_002.jpg',3,1,3,'2017-06-07 07:39:45','2017-06-07 07:39:45',NULL,2),(4,'latest__news__lintas__ebtke595d187d95fa6_577x305.jpg',4,1,2,'2017-07-05 16:49:01',NULL,1,1),(5,'latest__news__lintas__ebtke595d1f99be257_577x305.jpg',5,1,1,'2017-07-05 17:19:21',NULL,1,2);
...
--
-- Table structure for table `nrecc_category`
--

DROP TABLE IF EXISTS `nrecc_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nrecc_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `is_active` tinyint(1) DEFAULT NULL,
  `order` int(3) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
...
--
-- Dumping data for table `nrecc_category`
--

LOCK TABLES `nrecc_category` WRITE;
/*!40000 ALTER TABLE `nrecc_category` DISABLE KEYS */;
INSERT INTO `nrecc_category` VALUES (1,1,1,'2017-07-05 16:49:01','2017-07-05 16:49:01',1),(2,1,2,'2017-07-05 16:49:01','2017-07-05 16:49:01',1),(3,1,3,'2017-07-05 16:49:01','2017-07-05 16:49:01',1),(4,1,4,'2017-07-05 16:49:01','2017-07-05 16:49:01',1);
/*!40000 ALTER TABLE `nrecc_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `nrecc_category_trans`
--

DROP TABLE IF EXISTS `nrecc_category_trans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nrecc_category_trans` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `locale` varchar(2) DEFAULT NULL,
...
--
-- Dumping data for table `nrecc_event`
--

LOCK TABLES `nrecc_event` WRITE;
/*!40000 ALTER TABLE `nrecc_event` DISABLE KEYS */;
/*!40000 ALTER TABLE `nrecc_event` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `nrecc_event_trans`
--

DROP TABLE IF EXISTS `nrecc_event_trans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nrecc_event_trans` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `locale` varchar(2) NOT NULL,
  `slug` varchar(255) NOT NULL,
...
--
-- Dumping data for table `nrecc_event_trans`
--

LOCK TABLES `nrecc_event_trans` WRITE;
/*!40000 ALTER TABLE `nrecc_event_trans` DISABLE KEYS */;
/*!40000 ALTER TABLE `nrecc_event_trans` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `nrecc_institution`
--

DROP TABLE IF EXISTS `nrecc_institution`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nrecc_institution` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `thumbnail` varchar(255) DEFAULT NULL,
  `introduction_images` varchar(255) DEFAULT NULL,
  `description_images` varchar(45) DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT NULL,
  `order` int(3) DEFAULT NULL,
...
--
-- Dumping data for table `nrecc_institution`
--

LOCK TABLES `nrecc_institution` WRITE;
/*!40000 ALTER TABLE `nrecc_institution` DISABLE KEYS */;
INSERT INTO `nrecc_institution` VALUES (1,'Hurricane.jpg','Hurricane.jpg','Hurricane.jpg',1,1,1,NULL,'2017-07-05 16:49:01','2017-07-05 16:49:01',1),(2,'Hurricane.jpg','Hurricane.jpg','Hurricane.jpg',1,2,2,NULL,'2017-07-05 16:49:01','2017-07-05 16:49:01',1),(3,'Hurricane.jpg','Hurricane.jpg','Hurricane.jpg',1,3,3,NULL,'2017-07-05 16:49:01','2017-07-05 16:49:01',1),(4,'Hurricane.jpg','Hurricane.jpg','Hurricane.jpg',1,4,4,NULL,'2017-07-05 16:49:01','2017-07-05 16:49:01',1),(5,'Hurricane.jpg','Hurricane.jpg','Hurricane.jpg',1,4,4,NULL,'2017-07-05 16:49:01','2017-07-05 16:49:01',1);
/*!40000 ALTER TABLE `nrecc_institution` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `nrecc_institution_trans`
--

DROP TABLE IF EXISTS `nrecc_institution_trans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nrecc_institution_trans` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `locale` varchar(2) NOT NULL,
  `slug` varchar(255) NOT NULL,
...
--
-- Dumping data for table `nrecc_institution_trans`
--

LOCK TABLES `nrecc_institution_trans` WRITE;
/*!40000 ALTER TABLE `nrecc_institution_trans` DISABLE KEYS */;
INSERT INTO `nrecc_institution_trans` VALUES (1,'en','iea-closely-monitoring-situation-after-hurricane-harvey','IEA closely monitoring situation after Hurricane Harvey','<p>The IEA is monitoring the situation caused by Hurricane Harvey (Photograph: US National Oceanic and Atmospheric Administration)</p>','<p>The IEA is monitoring the situation caused by Hurricane Harvey very closely and is in contact with authorities in the United States.</p>','<p>It is too soon to know how long oil production and refining operations will be disrupted, or the extent of the damage. However, for now, the IEA does not see a need to act as the market is amply supplied. Oil stocks, both crude and products, are well above the five-year average, in the United States as well as globally.</p><p>The situation is being reviewed constantly and the IEA stands ready to act as required.</p>','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve',1,'2017-07-05 16:49:01','2017-07-05 16:49:01'),(2,'id','iea-erat-pemantauan-situasi-setelah-badai-harvey','IEA memantau situasi dengan ketat setelah Badai Harvey','<p> IEA memantau situasi yang disebabkan oleh Badai Harvey (Foto: Administrasi Oseanik dan Atmosfer Nasional AS) </ p>','<p> IEA memantau situasi yang disebabkan oleh Hurricane Harvey sangat erat dan berhubungan dengan pihak berwenang di Amerika Serikat. </ p>','<p> Terlalu dini untuk mengetahui berapa lama produksi minyak dan operasi penyulingan akan terganggu, atau tingkat kerusakannya. Namun, untuk saat ini, IEA tidak melihat adanya kebutuhan untuk bertindak karena pasar berlimpah. Stok minyak, baik minyak mentah dan produk, jauh di atas rata-rata lima tahun, di Amerika Serikat maupun di seluruh dunia. </p>\n\n<p> Situasi sedang ditinjau terus-menerus dan IEA siap bertindak sesuai kebutuhan. </p>\n','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve',1,'2017-07-05 16:49:01','2017-07-05 16:49:01'),(3,'en','iea-closely-monitoring-situation-after-hurricane-harvey-1','IEA closely monitoring situation after Hurricane Harvey','<p>The IEA is monitoring the situation caused by Hurricane Harvey (Photograph: US National Oceanic and Atmospheric Administration)</p>','<p>The IEA is monitoring the situation caused by Hurricane Harvey very closely and is in contact with authorities in the United States.</p>','<p>It is too soon to know how long oil production and refining operations will be disrupted, or the extent of the damage. However, for now, the IEA does not see a need to act as the market is amply supplied. Oil stocks, both crude and products, are well above the five-year average, in the United States as well as globally.</p><p>The situation is being reviewed constantly and the IEA stands ready to act as required.</p>','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve',2,'2017-07-05 16:49:01','2017-07-05 16:49:01'),(4,'id','iea-erat-pemantauan-situasi-setelah-badai-harvey-1','IEA memantau situasi dengan ketat setelah Badai Harvey','<p> IEA memantau situasi yang disebabkan oleh Badai Harvey (Foto: Administrasi Oseanik dan Atmosfer Nasional AS) </ p>','<p> IEA memantau situasi yang disebabkan oleh Hurricane Harvey sangat erat dan berhubungan dengan pihak berwenang di Amerika Serikat. </ p>','<p> Terlalu dini untuk mengetahui berapa lama produksi minyak dan operasi penyulingan akan terganggu, atau tingkat kerusakannya. Namun, untuk saat ini, IEA tidak melihat adanya kebutuhan untuk bertindak karena pasar berlimpah. Stok minyak, baik minyak mentah dan produk, jauh di atas rata-rata lima tahun, di Amerika Serikat maupun di seluruh dunia. </p>\n\n<p> Situasi sedang ditinjau terus-menerus dan IEA siap bertindak sesuai kebutuhan. </p>\n','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve',2,'2017-07-05 16:49:01','2017-07-05 16:49:01'),(5,'en','iea-closely-monitoring-situation-after-hurricane-harvey-2','IEA closely monitoring situation after Hurricane Harvey','<p>The IEA is monitoring the situation caused by Hurricane Harvey (Photograph: US National Oceanic and Atmospheric Administration)</p>','<p>The IEA is monitoring the situation caused by Hurricane Harvey very closely and is in contact with authorities in the United States.</p>','<p>It is too soon to know how long oil production and refining operations will be disrupted, or the extent of the damage. However, for now, the IEA does not see a need to act as the market is amply supplied. Oil stocks, both crude and products, are well above the five-year average, in the United States as well as globally.</p><p>The situation is being reviewed constantly and the IEA stands ready to act as required.</p>','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve',3,'2017-07-05 16:49:01','2017-07-05 16:49:01'),(6,'id','iea-erat-pemantauan-situasi-setelah-badai-harvey-2','IEA memantau situasi dengan ketat setelah Badai Harvey','<p> IEA memantau situasi yang disebabkan oleh Badai Harvey (Foto: Administrasi Oseanik dan Atmosfer Nasional AS) </ p>','<p> IEA memantau situasi yang disebabkan oleh Hurricane Harvey sangat erat dan berhubungan dengan pihak berwenang di Amerika Serikat. </ p>','<p> Terlalu dini untuk mengetahui berapa lama produksi minyak dan operasi penyulingan akan terganggu, atau tingkat kerusakannya. Namun, untuk saat ini, IEA tidak melihat adanya kebutuhan untuk bertindak karena pasar berlimpah. Stok minyak, baik minyak mentah dan produk, jauh di atas rata-rata lima tahun, di Amerika Serikat maupun di seluruh dunia. </p>\n\n<p> Situasi sedang ditinjau terus-menerus dan IEA siap bertindak sesuai kebutuhan. </p>\n','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve',3,'2017-07-05 16:49:01','2017-07-05 16:49:01'),(7,'en','iea-closely-monitoring-situation-after-hurricane-harvey-3','IEA closely monitoring situation after Hurricane Harvey','<p>The IEA is monitoring the situation caused by Hurricane Harvey (Photograph: US National Oceanic and Atmospheric Administration)</p>','<p>The IEA is monitoring the situation caused by Hurricane Harvey very closely and is in contact with authorities in the United States.</p>','<p>It is too soon to know how long oil production and refining operations will be disrupted, or the extent of the damage. However, for now, the IEA does not see a need to act as the market is amply supplied. Oil stocks, both crude and products, are well above the five-year average, in the United States as well as globally.</p><p>The situation is being reviewed constantly and the IEA stands ready to act as required.</p>','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve',4,'2017-07-05 16:49:01','2017-07-05 16:49:01'),(8,'id','iea-erat-pemantauan-situasi-setelah-badai-harvey-3','IEA memantau situasi dengan ketat setelah Badai Harvey','<p> IEA memantau situasi yang disebabkan oleh Badai Harvey (Foto: Administrasi Oseanik dan Atmosfer Nasional AS) </ p>','<p> IEA memantau situasi yang disebabkan oleh Hurricane Harvey sangat erat dan berhubungan dengan pihak berwenang di Amerika Serikat. </ p>','<p> Terlalu dini untuk mengetahui berapa lama produksi minyak dan operasi penyulingan akan terganggu, atau tingkat kerusakannya. Namun, untuk saat ini, IEA tidak melihat adanya kebutuhan untuk bertindak karena pasar berlimpah. Stok minyak, baik minyak mentah dan produk, jauh di atas rata-rata lima tahun, di Amerika Serikat maupun di seluruh dunia. </p>\n\n<p> Situasi sedang ditinjau terus-menerus dan IEA siap bertindak sesuai kebutuhan. </p>\n','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve',4,'2017-07-05 16:49:01','2017-07-05 16:49:01'),(9,'en','iea-closely-monitoring-situation-after-hurricane-harvey-4','IEA closely monitoring situation after Hurricane Harvey','<p>The IEA is monitoring the situation caused by Hurricane Harvey (Photograph: US National Oceanic and Atmospheric Administration)</p>','<p>The IEA is monitoring the situation caused by Hurricane Harvey very closely and is in contact with authorities in the United States.</p>','<p>It is too soon to know how long oil production and refining operations will be disrupted, or the extent of the damage. However, for now, the IEA does not see a need to act as the market is amply supplied. Oil stocks, both crude and products, are well above the five-year average, in the United States as well as globally.</p><p>The situation is being reviewed constantly and the IEA stands ready to act as required.</p>','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve','IEA closely monitoring situation after Hurricane Harve',5,'2017-07-05 16:49:01','2017-07-05 16:49:01'),(10,'id','iea-erat-pemantauan-situasi-setelah-badai-harvey-4','IEA memantau situasi dengan ketat setelah Badai Harvey','<p> IEA memantau situasi yang disebabkan oleh Badai Harvey (Foto: Administrasi Oseanik dan Atmosfer Nasional AS) </ p>','<p> IEA memantau situasi yang disebabkan oleh Hurricane Harvey sangat erat dan berhubungan dengan pihak berwenang di Amerika Serikat. </ p>','<p> Terlalu dini untuk mengetahui berapa lama produksi minyak dan operasi penyulingan akan terganggu, atau tingkat kerusakannya. Namun, untuk saat ini, IEA tidak melihat adanya kebutuhan untuk bertindak karena pasar berlimpah. Stok minyak, baik minyak mentah dan produk, jauh di atas rata-rata lima tahun, di Amerika Serikat maupun di seluruh dunia. </p>\n\n<p> Situasi sedang ditinjau terus-menerus dan IEA siap bertindak sesuai kebutuhan. </p>\n','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve','IEA memantau situasi dengan ketat setelah Badai Harve',5,'2017-07-05 16:49:01','2017-07-05 16:49:01');
/*!40000 ALTER TABLE `nrecc_institution_trans` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `nrecc_resources`
--

DROP TABLE IF EXISTS `nrecc_resources`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nrecc_resources` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `thumbnail` varchar(255) DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT NULL,
  `order` int(3) DEFAULT NULL,
...
--
-- Dumping data for table `nrecc_resources`
--

LOCK TABLES `nrecc_resources` WRITE;
/*!40000 ALTER TABLE `nrecc_resources` DISABLE KEYS */;
/*!40000 ALTER TABLE `nrecc_resources` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `nrecc_resources_trans`
--

DROP TABLE IF EXISTS `nrecc_resources_trans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nrecc_resources_trans` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `locale` varchar(2) NOT NULL,
  `slug` varchar(255) NOT NULL,
  `introduction` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `nrecc_resources_trans`
--

LOCK TABLES `nrecc_resources_trans` WRITE;
...
-- Dump completed on 2017-09-03 23:24:10
