<form action="{{ route('CompanyHistoryStoreData') }}" method="POST" id="CompanyHistoryManagementFrom" class="form" enctype="multipart/form-data" @submit.prevent>
					...
					<div class="form__group__row">
						...
						<div :id="'form-accordion-'+supportedLangKey+'-1'">
							...
							<div class="create__form__row">
								<div class="create__form__row">
									<div class="new__form__field full-width" style="width: 500px;">
										<label>Description Left <b>(@{{ supportedLang.name }})</b></label>
										<textarea v-model="models.description_left[supportedLangKey]" :name="'description_left['+supportedLangKey+']'" class="ckeditor" :id="'editor-'+supportedLangKey+'-2'"></textarea>
										<div class="form--error--message" id="form--error--message--description_left_@{{supportedLangKey}}"></div>
									</div>
								</div>
							</div>
							<div class="create__form__row">
								<div class="create__form__row">
									<div class="new__form__field full-width" style="width: 500px;">
										<label>Description Right <b>(@{{ supportedLang.name }})</b></label>
										<textarea v-model="models.description_right[supportedLangKey]" :name="'description_right['+supportedLangKey+']'" class="ckeditor" :id="'editor-'+supportedLangKey+'-3'"></textarea>
										<div class="form--error--message" id="form--error--message--description_right_@{{supportedLangKey}}"></div>
									</div>
								</div>
							</div>
						</div>
