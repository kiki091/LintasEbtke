<form action="{{ route('CmsNewsEditImageSlider') }}" method="POST" id="NewsImageSliderFrom" enctype="multipart/form-data" files="true" @submit.prevent>
					...
					<div class="create__form__row">
						<div class="new__form__field width-auto">
							...
							<div class="form__photo__uploader single__image">
								...
								<small><span>Upload Tip: </span>Please upload high resolution photo only with format of *jpeg. <br />(<b>Desktop</b> With Dimension: {{ NEWS_IMAGES_WIDTH }} x {{ NEWS_IMAGES_HEIGHT }} pixels)</small>
							</div>
						</div>
					</div>
				</div>
