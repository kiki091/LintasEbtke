<form action="{{ route('CmsEventStoreData') }}" method="POST" id="EventContentManagementFrom" class="form" enctype="multipart/form-data" @submit.prevent>
								...
								<div class="new__form__field">
									...
									<div class="content__input__wrapper__form">
										<div class="input-icon">
											<input v-model="models.date_start" name="date_start" type="text" class="form-control datetimepicker datetime start" placeholder="Isikan tanggal mulai event">
											<div class="icon__wrapper__form date-icon">
		                                        <i class="ico-date"></i>
		                                    </div>
										</div>
									</div>
									<div class="form--error--message" id="form--error--message--date_start"></div>
								</div>
							</div>
							<div class="create__form__row" v-if="showElementByDefaultLang(supportedLangKey)">
								<div class="new__form__field">
									...
									<div class="content__input__wrapper__form">
										<div class="input-icon">
											<input v-model="models.date_end" name="date_end" type="text" class="form-control datetimepicker datetime end" placeholder="Isikan tanggal berakhir event">
											<div class="icon__wrapper__form date-icon">
		                                        <i class="ico-date"></i>
		                                    </div>
										</div>
									</div>
									<div class="form--error--message" id="form--error--message--date_end"></div>
								</div>
							</div>
							<div class="create__form__row" v-if="showElementByDefaultLang(supportedLangKey)">
