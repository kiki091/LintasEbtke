<form action="{{ route('SeoRenewableIndustriPagesStoreData') }}" method="POST" id="SeoRenewableIndustriManagementFrom" class="form" enctype="multipart/form-data" @submit.prevent>
