<form action="{{ route('SeoServicesProcedureStoreData') }}" method="POST" id="SeoServicesProcesdureManagementFrom" class="form" enctype="multipart/form-data" @submit.prevent>
