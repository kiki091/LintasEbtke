      ...
      -->
  		<div class="login_wrapper">
              ...
              <div class="login__header">
                  <img src="{{ asset(DEFAULT_LOGO_CMS_DIRECTORY) }}">

              </div>
              <hr class="line__login">
          		<section class="login_content">
              		<form class="form__login" role="form" method="POST" action="{{ route('authenticate') }}">

                    	@if (count($errors) > 0)
                          	@foreach ($errors->all() as $error)
                            
                              	<p class="form--error--message-login">{{ $error }}</p>
                    ...
                    <div class="form-group">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
    			        ...
    			        <div class="separator">
                    		<p class="change_link">New to access ?
