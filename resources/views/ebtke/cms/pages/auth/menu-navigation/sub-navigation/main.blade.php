		...
		<div class="main__content__layer">
			<div class="content__top flex-between">
				...
				<!-- <div class="content__btn">
					<a href="#" class="btn__add" id="toggle-form">Add Sub Menu Navigation</a>
		       	</div> -->
		    </div>
		    <div class="content__bottom">
		    	<ul class="news__list sortable" id="sort" v-sort>
		    		<li class="news__list__wrapper sort-item" v-for="sub_navigation in responseData.sub_navigation" :data-id="sub_navigation.id">
		    			<div class="news__list__detail">
							...
							<div class="news__list__detail__middle-right">
								...
								<div class="news__list__detail__right">
									<label class="switch">
										<input class="switch-input" id="check_1" type="checkbox" :checked="sub_navigation.is_active == true" @change="changeStatus(sub_navigation.id)"/>
