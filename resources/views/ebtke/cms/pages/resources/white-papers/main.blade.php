<div id="app">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
    	<!-- Include form -->
    	@include('ebtke.cms.pages.resources.white-papers.partials.form')
    	<!-- / End include form -->
		<div class="main__content__layer">
			<div class="content__top flex-between">
				...
				<div class="content__btn">
					<a href="#" class="btn__add" id="toggle-form">Add White Papers</a>
		       	</div>
		    </div>
		    <div class="content__bottom">
		    	<ul class="news__list sortable" id="sort" v-sort>
		    		<li class="news__list__wrapper sort-item" v-for="white_papers in responseData.white_papers" :data-id="white_papers.id">
		    			<div class="news__list__detail">
							...
							<div class="news__list__detail__left">
								<img :src=white_papers.thumbnail_url>
							</div>
							<div class="news__list__detail__middle-right">
								<div class="news__list__detail__middle">
									<div class="news__list__desc">
										<div class="news__name">
											<a href="#edit-data" class="title__name content__edit__hover" title="Edit Data" @click="editData(white_papers.id)">
												@{{ white_papers.title }}
											</a>
										</div>
									</div>
								...
								<div class="news__list__detail__right">
									<label class="switch">
										<input class="switch-input" id="check_1" type="checkbox" :checked="white_papers.is_active == true" @change="changeStatus(white_papers.id)"/>
                                    	<span class="switch-label" data-on="Active" data-off="Inactive"></span> <span class="switch-handle"></span>
									</label>
									<a href="#" class="btn__delete" @click="showDeleteModal(white_papers.id)">
