<div id="app">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
    	<!-- Include form -->
    	@include('ebtke.cms.pages.resources.tools.partials.form')
    	<!-- / End include form -->
		<div class="main__content__layer">
			<div class="content__top flex-between">
				...
				<div class="content__btn">
					<a href="#" class="btn__add" id="toggle-form">Add Tools</a>
		       	</div>
		    </div>
		    <div class="content__bottom">
		    	<ul class="news__list sortable" id="sort" v-sort>
		    		<li class="news__list__wrapper sort-item" v-for="tools in responseData.tools" :data-id="tools.id">
		    			<div class="news__list__detail">
							...
							<div class="news__list__detail__left">
								<img :src=tools.thumbnail_url>
							</div>
							<div class="news__list__detail__middle-right">
								<div class="news__list__detail__middle">
									<div class="news__list__desc">
										<div class="news__name">
											<a href="javascript:void(0);" class="title__name content__edit__hover" title="Edit Data" @click="editData(tools.id)">
												@{{ tools.filename }}
											</a>
										</div>
									</div>
								...
								<div class="news__list__detail__right">
									<label class="switch">
										<input class="switch-input" id="check_1" type="checkbox" :checked="tools.is_active == true" @change="changeStatus(tools.id)"/>
                                    	<span class="switch-label" data-on="Active" data-off="Inactive"></span> <span class="switch-handle"></span>
									</label>
									<a href="javascript:void(0);" class="btn__delete" @click="showDeleteModal(tools.id)">
