<form action="{{ route('CmsEnergyConservationStoreData') }}" method="POST" id="EnergyConservationContentManagementFrom" class="form" enctype="multipart/form-data" @submit.prevent>
							...
							<div class="create__form__row" v-if="showElementByDefaultLang(supportedLangKey)">
								<div class="new__form__field upload__image">
									...
									<div class="upload__tip">
										<span><b>Upload Tip: </b>Please upload high resolution photo only with format of *jpeg. (With maximum width of {{ ENERGY_CONSEREVATION_THUMBNAIL_WIDTH }} x {{ ENERGY_CONSEREVATION_THUMBNAIL_HEIGHT }} px on landscape)</span>
									</div>
								</div>
							</div>
							...
							<div class="create__form__row">
								<div class="create__form__row">
									<div class="new__form__field full-width" style="width: 500px;">
										...
										<div class="form--error--message--left" :id="'form--error--message--introduction_'+supportedLangKey"></div>
									</div>
								</div>
							</div>
							<div class="create__form__row">
								<div class="create__form__row">
									<div class="new__form__field full-width" style="width: 500px;">
										...
										<div class="form--error--message--left" :id="'form--error--message--description_'+supportedLangKey"></div>
									</div>
								</div>
							</div>
							<div class="create__form__row">
								<div class="create__form__row">
									<div class="new__form__field full-width" style="width: 500px;">
										<label>Description Maps <b>(@{{ supportedLang.name }})</b></label>
										<textarea v-model="models.description_maps[supportedLangKey]" :name="'description_maps['+supportedLangKey+']'" class="ckeditor" :id="'editor-'+supportedLangKey+'-3'"></textarea>
										<div class="form--error--message--left" :id="'form--error--message--description_maps_'+supportedLangKey"></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div :id="'form-accordion-'+supportedLangKey+'-seo'">
								<div class="create__form__row form--media">
									<div class="new__form__field" style="width: 500px;">
										...
										<div class="form--error--message--left" :id="'form--error--message--meta_title_'+supportedLangKey"></div>
									</div>
								</div>
								<div class="create__form__row form--media">
									<div class="new__form__field" style="width: 500px;">
										...
										<div class="form--error--message--left" :id="'form--error--message--meta_description_'+supportedLangKey"></div>
									</div>
								</div>
								<div class="create__form__row form--media">
									<div class="new__form__field" style="width: 500px;">
										...
										<div class="form--error--message--left" :id="'form--error--message--meta_keyword_'+supportedLangKey"></div>
									</div>
								</div>
							</div>
						</div>
