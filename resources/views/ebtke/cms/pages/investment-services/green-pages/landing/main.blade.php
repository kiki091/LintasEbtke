		...
		<div class="main__content__layer">
		    ...
		    <div class="content__bottom">
		    	<ul class="news__list sortable" id="sort" v-sort>
		    		<li class="news__list__wrapper sort-item" v-for="green_pages in responseData.green_pages" :data-id="green_pages.id">
		    			<div class="news__list__detail">
							...
							<div class="news__list__detail__left">
								<img :src=green_pages.thumbnail_url>
							</div>
							<div class="news__list__detail__middle-right">
								...
								<div class="news__list__detail__right">
									<label class="switch">
										<input class="switch-input" id="check_1" type="checkbox" :checked="green_pages.is_active == true" @change="changeStatus(green_pages.id)"/>
                                    	<span class="switch-label" data-on="Active" data-off="Inactive"></span> <span class="switch-handle"></span>
									</label>
									<a href="javascript:void(0)" class="btn__action__list" @click="editImageSlider(green_pages.id)">
										<i class="fa fa-image fa-lg"></i>
									</a>
									<a href="#" class="btn__delete" @click="showDeleteModal(green_pages.id)">
