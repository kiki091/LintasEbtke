		...
		<div class="main__content__layer">
			<div class="content__top flex-between">
				...
				<div class="content__btn">
					<a href="#" class="btn__add" id="toggle-form">Add Green Pages Category</a>
		       	</div>
		    </div>
		    <div class="content__bottom">
		    	<ul class="news__list sortable" id="sort" v-sort>
		    		<li class="news__list__wrapper sort-item" v-for="category in responseData.category" :data-id="category.id">
		    			<div class="news__list__detail">
							...
							<div class="news__list__detail__middle-right">
								<div class="news__list__detail__middle">
									<div class="news__list__desc">
										<div class="news__name">
											<a href="#edit-data" class="title__name content__edit__hover" title="Edit Data" @click="editData(category.id)">
												@{{ category.title }}
											</a>
										</div>
									</div>
								...
								<div class="news__list__detail__right">
									...
									<a href="#" class="btn__delete" @click="showDeleteModal(category.id)">
