<form action="{{ route('InvestmentServicesStoreData') }}" method="POST" id="InvestmentServicesManagementFrom" class="form" enctype="multipart/form-data" @submit.prevent>
							...
							<div class="create__form__row" v-if="showElementByDefaultLang(supportedLangKey)">
								<div class="new__form__field upload__image">
									...
									<div class="upload__tip">
										<span><b>Upload Tip: </b>Please upload high resolution photo only with format of *jpeg. (With maximum width of {{ INVESTMENT_SERVICES_THUMBNAIL_WIDTH }} x {{ INVESTMENT_SERVICES_THUMBNAIL_HEIGHT }} px on landscape)</span>
									</div>
								</div>
							</div>
							...
							<div class="create__form__row" v-if="showElementByDefaultLang(supportedLangKey) && edit == false" >
								<div class="new__form__field " style="width: 500px;">
									...
									<div class="form__photo__uploader single__image">
										...
										<small><span>Upload Tip: </span>Please upload high resolution photo only with format of *jpeg. <br />(<b>Mobile</b> With Dimension: {{ INVESTMENT_SERVICES_IMAGES_WIDTH }} x {{ INVESTMENT_SERVICES_IMAGES_HEIGHT }} pixels)</small>
									</div>
								</div>
							</div>
							...
							<div class="create__form__row" v-if="showElementByDefaultLang(supportedLangKey) && edit == false">
								<div class="new__form__field" style="width: 100%">
									...
									<div class="field__icon">
										<div class="">
											<ul class="to_do">
												<li v-for="investment_services_related_id in responseData.investment_services">
													<p>
														<div class="checkbox icheck-primary">
														    <input class="checkbox__data" type="checkbox" name="investment_services_related_id[]" :id=" 'checkbox-investment_services_related_id-' + investment_services_related_id.id" :value="investment_services_related_id.id"/>
														    <label :for=" 'checkbox-investment_services_related_id-' + investment_services_related_id.id">@{{ investment_services_related_id.title }}</label>
														</div>
													</p>
												</li>
											</ul>
									...
									<div class="form--error--message--left" id="form--error--message--investment_services_related_id"></div>
							...
							<div class="create__form__row" v-if="showElementByDefaultLang(supportedLangKey) && edit == true">
								<div class="new__form__field" style="width: 100%">
									...
									<div class="field__icon">
										<div class="">
											<ul class="to_do">
												<li v-for="investment_services_related_id in investment_services_related_id">
													<p>
														<div class="checkbox icheck-primary">
														    <input class="checkbox__data" type="checkbox" name="investment_services_related_id[]" :id=" 'checkbox-investment_services_related_id-' + investment_services_related_id.id" :value="investment_services_related_id.id" :checked="investment_services_related_id.is_checked == true"/>
														    <label :for=" 'checkbox-investment_services_related_id-' + investment_services_related_id.id">@{{ investment_services_related_id.title }}</label>
														</div>
													</p>
												</li>
