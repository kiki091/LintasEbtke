<div id="app">
	<div class="bg__gray">
		<div class="page-title">
			<div class="title_left">
		        <h3>INVESTMENT SERVICES CONTENT </h3>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
    	<!-- Include form -->
    	@include('ebtke.cms.pages.investment-services.services.partials.form')
    	@include('ebtke.cms.pages.investment-services.services.partials.form-images-slider')
    	<!-- / End include form -->
		<div class="main__content__layer">
			<div class="content__top flex-between">
				...
				<div class="content__btn">
					<a href="#" class="btn__add" id="toggle-form">Add Investment Services</a>
		       	</div>
		    </div>
		    <div class="content__bottom">
		    	<ul class="news__list sortable" id="sort" v-sort>
		    		<li class="news__list__wrapper sort-item" v-for="investment_services in responseData.investment_services" :data-id="investment_services.id">
		    			<div class="news__list__detail">
							...
							<div class="news__list__detail__left">
								<img :src=investment_services.thumbnail_url>
							</div>
							<div class="news__list__detail__middle-right">
								<div class="news__list__detail__middle">
									<div class="news__list__desc">
										<div class="news__name">
											<a href="#edit-data" class="title__name content__edit__hover" title="Edit Data" @click="editData(investment_services.id)">
												@{{ investment_services.title }}
											</a>
										</div>
									</div>
								</div>
								<div class="news__list__detail__right">
									<label class="switch">
										<input class="switch-input" id="check_1" type="checkbox" :checked="investment_services.is_active == true" @change="changeStatus(investment_services.id)"/>
                                    	<span class="switch-label" data-on="Active" data-off="Inactive"></span> <span class="switch-handle"></span>
									</label>
									<a href="javascript:void(0)" class="btn__action__list" @click="editImageSlider(investment_services.id)">
										<i class="fa fa-image fa-lg"></i>
									</a>
									<a href="#" class="btn__delete" @click="showDeleteModal(investment_services.id)">
