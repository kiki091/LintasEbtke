<div id="app">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
    	...
    	@include('ebtke.cms.pages.information-services.renewable-energy.list-certified-energy.partials.form')
    	<!-- / End include form -->
		<div class="main__content__layer">
		    ...
		    <div class="content__bottom">
		    	<ul class="news__list sortable" id="sort" v-sort>
		    		<li class="news__list__wrapper sort-item" v-for="list_certified_energy in responseData.list_certified_energy" :data-id="list_certified_energy.id">
		    			<div class="news__list__detail">
							...
							<div class="news__list__detail__middle-right">
								<div class="news__list__detail__middle">
									<div class="news__list__desc">
										<div class="news__name">
											<a href="javascript:void(0);" class="title__name content__edit__hover" title="Edit Data" @click="editData(list_certified_energy.id)">
												@{{ list_certified_energy.company_name }}
											</a>
										</div>
									</div>
								</div>
								<div class="news__list__detail__right">
									<label class="switch">
										<input class="switch-input" id="check_1" type="checkbox" :checked="list_certified_energy.is_active == true" @change="changeStatus(list_certified_energy.id)"/>
                                    	<span class="switch-label" data-on="Active" data-off="Inactive"></span> <span class="switch-handle"></span>
									</label>
									<a href="#" class="btn__delete" @click="showDeleteModal(list_certified_energy.id)">
