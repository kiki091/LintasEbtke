<form action="{{ route('CmsIndustryStoreData') }}" method="POST" id="IndustryContentManagementFrom" class="form" enctype="multipart/form-data" @submit.prevent>
							...
							<div class="create__form__row" v-if="showElementByDefaultLang(supportedLangKey)">
								<div class="new__form__field upload__image">
									...
									<div class="upload__tip">
										<span><b>Upload Tip: </b>Please upload high resolution photo only with format of *jpeg. (With maximum width of {{ INDUSTRY_THUMBNAIL_WIDTH }} x {{ INDUSTRY_THUMBNAIL_HEIGHT }} px on landscape)</span>
									</div>
								</div>
							</div>
