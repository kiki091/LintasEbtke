<form action="{{ route('sipeda_investasi_pabrikan_aneka_ebt_store') }}" method="POST" id="sipeda_investasi_pabrikan_aneka_ebt" class="form" enctype="multipart/form-data" @submit.prevent>
						...
						<div id="form-accordion-1">
							<div class="create__form__row">
								<div class="new__form__field">
									...
									<select class="form-control" name="nama_produk" v-model="models.nama_produk">
										<option value="1">Module Surya</option>
										<option value="2">Baterei VRLA</option>
										<option value="3">Baterei Lithium</option>
										<option value="4">Baterei Zinc Cair</option>
										<option value="5">Inverter</option>
										<option value="6">Controller</option>
										<option value="7">Turbin Air</option>
										<option value="8">Turbin Angin</option>
									</select>
									<div class="form--error--message--left" id="form--error--message--nama_produk"></div>
								</div>
							</div>
							...
							<div class="create__form__row">
								<div class="new__form__field">
									<label>Kapasitas Produksi <b>Jumlah</b></label>
									<input name="kapasitas_produksi" v-model="models.kapasitas_produksi" type="text" id="kapasitas_produksi" class="new__form__input__field" placeholder="Enter The Kapasitas Produksi">
									<div class="form--error--message--left" id="form--error--message--kapasitas_produksi"></div>
								</div>
							</div>

							<div class="create__form__row">
								<div class="new__form__field">
									<label>Kapasitas Produksi <b>Satuan</b></label>
									<select class="form-control" name="satuan_kapasitas_produksi" v-model="models.satuan_kapasitas_produksi">
										<option value="watt">Watt</option>
										<option value="unit">Unit</option>
									</select>
									<div class="form--error--message--left" id="form--error--message--satuan_kapasitas_produksi"></div>
								</div>
							</div>
