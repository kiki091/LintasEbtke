<div id="app_sipeda">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
    	<!-- Include form -->
    	@include('ebtke.sipeda.pages.capacity-building.partials.form')
    	<!-- / End include form -->
		<div class="main__content__layer">
		    ...
		    <div class="content__bottom">
		    	<ul class="news__list sortable" id="sort">
		    		<li class="news__list__wrapper sort-item" v-for="capacity_building in responseData.capacity_building" :data-id="capacity_building.id">
		    			<div class="news__list__detail">
		    				<div class="drag__control">
								<div class="handle">
									@include('ebtke.sipeda.svg-logo.ico-handle-drag')
								</div>
							</div>
								...
								<div class="news__list__detail__middle">
									<div class="news__list__desc">
										<div class="news__name">
											<a href="javascript:void(0);" class="title__name content__edit__hover" title="Edit Data" @click="editData(capacity_building.id)">
												@{{ capacity_building.topik_kegiatan }}
											</a>
										</div>
										<div class="news__desc">
											<p class="news__cat"> <b>Periode : </b><i>@{{ capacity_building.tahun_perencanaan }}</i> <b>To : </b><i>@{{ capacity_building.tahun_pelaksanaan }}</i></p>
										</div>
									</div>
								</div>
								<div class="news__list__detail__right">
									<label class="switch">
										<input class="switch-input" id="check_1" type="checkbox" :checked="capacity_building.is_publish == true" @change="changeStatus(capacity_building.id)"/>
                                    	<span class="switch-label" data-on="Publish" data-off="Not Publish"></span> <span class="switch-handle"></span>
									</label>
									<a href="#" class="btn__delete" @click="showDeleteModal(capacity_building.id)">
