...
function crudSeoTools() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Seo Tools Manager",
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('SeoToolsPagesGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#SeoToolsManagementFrom").ajaxForm(optForm);
                $("#SeoToolsManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('SeoToolsPagesEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Seo Tools Manager"
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Seo Tools Manager"
                document.getElementById("SeoToolsManagementFrom");
