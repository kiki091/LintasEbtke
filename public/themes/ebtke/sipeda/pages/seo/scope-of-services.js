...
function crudSeoLintasOfScope() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Seo Lintas Of Scope Manager",
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('SeoLintasOfScopeGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#SeoLintasOfScopePageManagementFrom").ajaxForm(optForm);
                $("#SeoLintasOfScopePageManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('SeoLintasOfScopeEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Seo Vision & Mission Manager"
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Seo Lintas Of Scope Manager"
                document.getElementById("SeoLintasOfScopePageManagementFrom");
