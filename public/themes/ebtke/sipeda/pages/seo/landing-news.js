...
function crudSeoNewsPages() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Seo News Pages Manager",
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('SeoNewsPagesGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#SeoNewsPagesManagementFrom").ajaxForm(optForm);
                $("#SeoNewsPagesManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('SeoNewsPagesEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Seo News Pages Manager"
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Seo News Pages Manager"
                document.getElementById("SeoNewsPagesManagementFrom");
