...
function crudListEnergyAuditor() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            available_year: ["2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021"],
            delete_payload: {
              id: ''
            },
            ...
            form_add_title: "List Auditor Certified Energy",
            id: '',
            edit: false,
            showModal: false,
            responseData: {}
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('CmsListAuditorEnergyGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#ListAuditorEnergyManagementFrom").ajaxForm(optForm);
                $("#ListAuditorEnergyManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('CmsListAuditorEnergyEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit List Manager Certified Energy"
                        $('.btn__add').click()
            ...
            changeStatus: function(id) {
                ...
                var domain  = laroute.route('CmsListAuditorEnergyChangeStatus', []);
            ...
            deleteData: function(id) {
                var domain  = laroute.route('CmsListAuditorEnergyDeleteData', []);
                var form = new FormData();
            ...
            resetForm: function(setEditToFalse) {
                ...
                for (var supported_lang in this.supported_language) {
                    this.models.sector[supported_lang] = ''
                    this.models.sub_sector[supported_lang] = ''
                }
                ...
                this.models.company_name = ''
                this.models.province_id = ''
                this.models.type_auditor = ''
                this.models.years = ''

                this.models['language_selected'] = [];

                this.form_add_title = "List Auditor Certified Energy"
                document.getElementById("ListAuditorEnergyManagementFrom");
            ...
            reorder: function(oldIndex, newIndex) {
                ...
                var domain  = laroute.route('CmsListAuditorEnergyOrderData', []);
