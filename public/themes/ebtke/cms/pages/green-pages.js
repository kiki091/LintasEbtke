...
function crudGreenPages() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Green Pages Content Manager",
            id: '',
            edit: false,
            showModal: false,
            responseData: {},
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('GreenPagesGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#GreenPagesContentManagementFrom").ajaxForm(optForm);
                $("#GreenPagesContentManagementFrom").submit();
            },
            ...
            postEditImageSlider: function(event) {
                ...
                $("#GreenPagesImageSliderFrom").ajaxForm(optForm);
                $("#GreenPagesImageSliderFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('GreenPagesEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Green Pages Content Manager"
                        $('.btn__add').click()
            ...
            changeStatus: function(id) {
                ...
                var domain  = laroute.route('GreenPagesChangeStatus', []);
            ...
            deleteData: function(id) {
                var domain  = laroute.route('GreenPagesDeleteData', []);
                var form = new FormData();
            ...
            removeImageSliderFromServer: function (id, index) {
                ...
                var domain  = laroute.route('GreenPagesDeleteImageSlider', []);
                this.$http.post(domain, form).then(function(response) {
                    response = response.data
            ...
            resetForm: function(setEditToFalse) {
                ...
                this.form_add_title = "Green Pages Content Manager"
                document.getElementById("GreenPagesContentManagementFrom");
            ...
            reorder: function(oldIndex, newIndex) {
                ...
                var domain  = laroute.route('GreenPagesOrderData', []);
