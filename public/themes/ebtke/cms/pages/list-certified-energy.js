...
function crudListCertifiedEnergy() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "List Certified Energy",
            id: '',
            edit: false,
            showModal: false,
            responseData: {}
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('CmsListCertifiedEnergyGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#ListCertifiedEnergyManagementFrom").ajaxForm(optForm);
                $("#ListCertifiedEnergyManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('CmsListCertifiedEnergyEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit List Certified Energy"
                        $('.btn__add').click()
            ...
            changeStatus: function(id) {
                ...
                var domain  = laroute.route('CmsListCertifiedEnergyChangeStatus', []);
            ...
            deleteData: function(id) {
                var domain  = laroute.route('CmsListCertifiedEnergyDeleteData', []);
                var form = new FormData();
            ...
            resetForm: function(setEditToFalse) {
                ...
                this.form_add_title = "List Certified Energy"
                document.getElementById("ListCertifiedEnergyManagementFrom");
            ...
            reorder: function(oldIndex, newIndex) {
                ...
                var domain  = laroute.route('CmsListCertifiedEnergyOrderData', []);
