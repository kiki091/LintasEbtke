...
function crudSeoEventPages() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Seo Event Pages Manager",
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('SeoEventPagesGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#SeoEventPagesManagementFrom").ajaxForm(optForm);
                $("#SeoEventPagesManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('SeoEventPagesEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Seo Event Pages Manager"
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Seo Event Pages Manager"
                document.getElementById("SeoEventPagesManagementFrom");
