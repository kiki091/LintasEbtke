...
function crudSeoGreenPages() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Seo Green Pages Manager",
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('SeoGreenPagesGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#SeoGreenPagesManagementFrom").ajaxForm(optForm);
                $("#SeoGreenPagesManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('SeoGreenPagesEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Seo Green Pages Manager"
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Seo Green Pages Manager"
                document.getElementById("SeoGreenPagesManagementFrom");
