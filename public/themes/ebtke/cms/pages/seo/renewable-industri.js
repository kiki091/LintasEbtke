...
function crudSeoRenewableIndustri() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Seo Renewable Industri Manager",
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('SeoRenewableIndustriPagesGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#SeoRenewableIndustriManagementFrom").ajaxForm(optForm);
                $("#SeoRenewableIndustriManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('SeoRenewableIndustriPagesEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Seo Renewable Industri Manager"
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Seo Renewable Industri Manager"
                document.getElementById("SeoRenewableIndustriManagementFrom");
