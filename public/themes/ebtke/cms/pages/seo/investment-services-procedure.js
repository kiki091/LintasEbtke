...
function crudSeoServicesProcedure() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Seo Services Procesdure Manager",
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('SeoServicesProcedureGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#SeoServicesProcesdureManagementFrom").ajaxForm(optForm);
                $("#SeoServicesProcesdureManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('SeoServicesProcedureEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Seo Services Procesdure Manager"
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Seo Services Procesdure Manager"
                document.getElementById("SeoServicesProcesdureManagementFrom");
