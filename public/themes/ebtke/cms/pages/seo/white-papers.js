...
function crudSeoWhitePaper() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Seo White Paper Manager",
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('SeoWhitePaperPagesGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#SeoWhitePaperManagementFrom").ajaxForm(optForm);
                $("#SeoWhitePaperManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('SeoWhitePaperPagesEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Seo White Paper Manager"
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Seo White Paper Manager"
                document.getElementById("SeoWhitePaperManagementFrom");
