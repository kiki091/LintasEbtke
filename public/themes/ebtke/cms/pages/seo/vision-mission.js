...
function crudSeoVisionMission() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Seo Vision & Mission Manager",
            id: '',
            edit: false,
            responseData: {},
        },
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('SeoVisionMissionGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#SeoVisionMissionPageManagementFrom").ajaxForm(optForm);
                $("#SeoVisionMissionPageManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('SeoVisionMissionEditData', []);
            ...
            resetForm: function() {
                ...
                this.form_add_title = "Seo Vision & Mission Manager"
                document.getElementById("SeoVisionMissionPageManagementFrom");
