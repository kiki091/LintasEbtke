...
function crudGreenPagesCategory() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Green Pages Category Manager",
            id: '',
            edit: false,
            showModal: false,
            responseData: {},
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('GreenPagesCategoryGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#GreenPagesCategoryManagementFrom").ajaxForm(optForm);
                $("#GreenPagesCategoryManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('GreenPagesCategoryEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Green Pages Category Manager"
                        $('.btn__add').click()
            ...
            changeStatus: function(id) {
                ...
                var domain  = laroute.route('GreenPagesCategoryChangeStatus', []);
            ...
            deleteData: function(id) {
                var domain  = laroute.route('GreenPagesCategoryDeleteData', []);
                var form = new FormData();
            ...
            resetForm: function(setEditToFalse) {
                ...
                this.form_add_title = "Green Pages Category Manager"
                document.getElementById("GreenPagesCategoryManagementFrom");
            ...
            reorder: function(oldIndex, newIndex) {
                ...
                var domain  = laroute.route('GreenPagesCategoryOrderData', []);
