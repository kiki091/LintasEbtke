...
function crudEnergiConservation() {
    ...
    var controller = new Vue({
        ...
        data: {
            ...
            form_add_title: "Energy Conservation Content Manager",
            id: '',
            edit: false,
            showModal: false,
            responseData: {},
        ...
        methods: {
            ...
            fetchData: function() {
                ...
                var domain  = laroute.route('CmsEnergyConservationGetData', []);
            ...
            storeData: function(event) {
                ...
                $("#EnergyConservationContentManagementFrom").ajaxForm(optForm);
                $("#EnergyConservationContentManagementFrom").submit();
            },
            ...
            editData: function(id) {
                ...
                var domain  = laroute.route('CmsEnergyConservationEditData', []);
                this.$http.post(domain, form).then(function(response) {
                    ...
                    if (response.status) {
                        ...
                        this.form_add_title = "Edit Energy Conservation Content Manager"
                        $('.btn__add').click()
            ...
            changeStatus: function(id) {
                ...
                var domain  = laroute.route('CmsEnergyConservationChangeStatus', []);
            ...
            deleteData: function(id) {
                var domain  = laroute.route('CmsEnergyConservationDeleteData', []);
                var form = new FormData();
            ...
            resetForm: function(setEditToFalse) {
                ...
                for (var supported_lang in this.supported_language) {
                    ...
                    this.models.description_maps[supported_lang] = ''
                ...
                document.getElementById("EnergyConservationContentManagementFrom");
            ...
            reorder: function(oldIndex, newIndex) {
                ...
                var domain  = laroute.route('CmsEnergyConservationOrderData', []);
                ...
                try {
                    switch(id) {
                        ...
                        case 'template-description':
                            ...
                            break;
                        case 'template-description-maps':
