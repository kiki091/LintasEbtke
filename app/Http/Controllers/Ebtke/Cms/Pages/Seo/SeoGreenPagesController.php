...
class SeoGreenPagesController extends CmsBaseController
{
    ...
    const SEO_KEY = 'seo:investment-services:green-pages';
    ...
    {
        $blade = self::URL_BLADE_CMS. '.seo.investment-services.green-pages.main';
