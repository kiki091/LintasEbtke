...
class SeoWhitePaperController extends CmsBaseController
{
    ...
    const SEO_KEY = 'seo:resources:white-papers';
    ...
    {
        $blade = self::URL_BLADE_CMS. '.seo.resources.white-papers.main';
