...
class SeoServicesProcedureController extends CmsBaseController
{
    ...
    const SEO_KEY = 'seo:investment-services:procedure';
    ...
    {
        $blade = self::URL_BLADE_CMS. '.seo.investment-services.procedure.main';
