...
class ListEnergyAuditorController extends FrontController
{
    ...
    public function landing(Request $request)
    {
        ...
        $data['energy_auditor'] = $this->listEnergyAuditor->getData($request->except('_token'));
        $data['landing_industri'] = $this->industri->getData($request->except('_token'));

        $blade = self::URL_BLADE_FRONT_SITE.'.information-services.renewable.industri.energy-auditor';
