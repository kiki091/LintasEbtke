...
{
	/**
     * Get NreccResources Transformation
     * @param $data
     * @return array
     */
    public function getNreccResourcesTransform($data)
    {
        if(!is_array($data) || empty($data))
            return array();

        return $this->setNreccResourcesTransform($data);
    }

    /**
     * Get NreccResources Transformation Detail
     * @param $data
     * @return array
     */
    public function getNreccResourcesDetailTransform($data)
    {
        if(!is_array($data) || empty($data))
            return array();

        return $this->setNreccResourcesDetailTransform($data);
    }
     ...
     * @return array
     */
    protected function setNreccResourcesTransform($data)
    {
        if(!is_array($data) || empty($data))
            return array();
     ...
     * @return array
     */
    protected function setNreccResourcesDetailTransform($data)
    {
